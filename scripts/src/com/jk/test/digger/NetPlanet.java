...
public class NetPlanet  extends BaseCase {
	...
	public void  startNetPlanet() {
		String cmd = "am start -n com.netease.blockchain/.business.main.MainActivity ";
		Util.ExecCmd(cmd);
	}
	private void gain() {
		UiObject web = new UiObject(new UiSelector().resourceId("com.netease.blockchain:id/webview"));
		try {
