...
public class AssetsHelper {
    public static final String jarPath = "/sdcard/Android/data/com.zfz.android.taobaospider/files/UiTest.jar";
    ...
    public boolean copy() throws IOException {
        ...
        LogHelper.i("get assets list:"+assets.toString());
...
//            copy2DataTmp(file);
     ...
     *  @throws IOException
     */
    protected File copy2Sdcard( String asset ) throws IOException {

        InputStream source = mAssetManager.open(new File(asset).getPath());

        File destinationFile = new File(mAppDirectory, asset);
//        String directory = "/sdcard/Android/data/com.zfz.android.taobaospider/files";
