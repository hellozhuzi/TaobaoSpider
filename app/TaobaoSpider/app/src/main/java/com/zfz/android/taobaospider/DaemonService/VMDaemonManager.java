package com.zfz.android.taobaospider.DaemonService;

import android.content.Intent;
import android.support.v7.app.AppCompatActivity;
import android.util.Log;
import com.zfz.android.taobaospider.MyApplication;
...
public class VMDaemonManager {
    ...
    public void startDaemonActivity() {
        ...
        MyApplication.getContext()
                .startActivity(new Intent(MyApplication.getContext(), VMDaemonActivity.class));
    }
    ...
    public void startCoreProcess() {
        ...
        Intent wakeIntent = new Intent(MyApplication.getContext(), VMCoreService.class);
        MyApplication.getContext().startService(wakeIntent);
    }
